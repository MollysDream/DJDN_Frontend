...
const ModifyActiveScreen = (props) => {
    ...
    async function updateActive(){
        let active = !advertisement.active;
        await requestAdverAPI.updateAdverActive(advertisement._id, active);
    }
...
export default ModifyActiveScreen;
